...
class HttpBehavioralDnaClient(BehavioralDnaClient):
    """Calls Agent 1's existing read-only GET /customers/{customer_id}/profile
    - never POST /transactions/score, which advances the profile version and
    would corrupt Agent 1's audit trail if called from this downstream
    decision layer."""
