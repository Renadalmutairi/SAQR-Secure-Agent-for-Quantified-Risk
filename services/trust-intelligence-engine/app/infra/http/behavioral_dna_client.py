...
from app.domain.entities import BehavioralProfileSnapshot
...
class HttpBehavioralDnaClient(BehavioralDnaClient):
    ...
    endpoint, no modification to Agent 1. Reuses a shared httpx.AsyncClient
    (connection pooling) rather than opening one per request.
    """
